                                    ...
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/01.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-01">
                                            </a>
                                        </div>
                            ...
                            <li class="iq-rated-box swiper-slide">
                                <div class="iq-card mb-0">
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/02.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-02">
                                            </a>
                                        </div>
                                        <div class="iq-feature-list mt-3">
                            ...
                            <li class="iq-rated-box swiper-slide">
                                <div class="iq-card mb-0">
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/03.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-03">
                                            </a>
                                        </div>
                                        <div class="iq-feature-list mt-3">
                            ...
                            <li class="iq-rated-box swiper-slide">
                                <div class="iq-card mb-0">
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/04.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-04">
                                            </a>
                                        </div>
                                        <div class="iq-feature-list mt-3">
                            ...
                            <li class="iq-rated-box swiper-slide">
                                <div class="iq-card mb-0">
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/05.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-05">
                                            </a>
                                        </div>
                                        <div class="iq-feature-list mt-3">
                                            <h6 class="font-weight-600 mb-0">Last
                            ...
                            <li class="iq-rated-box swiper-slide">
                                <div class="iq-card mb-0">
                                    <div class="iq-card-body p-0">
                                        <div class="iq-thumb">
                                            <a href="javascript:void(0)">
                                                <img src="{{ asset('images/dashboard/06.jpg') }}" class="img-fluid w-100 img-border-radius" alt="topImg-06">
                                            </a>
                                        </div>
                                        <div class="iq-feature-list mt-3">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-movie">
                                                <a href="javascript:void(0);"><img src="{{ asset('images/movie-thumb/07.jpg') }}"
                                                        class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-01"></a>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-movie">
                                                <a href="javascript:void(0);"><img src="{{ asset('images/movie-thumb/01.jpg') }}"
                                                        class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-02"></a>
                                            </div>
                                            <div class="text-start ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-movie">
                                                <a href="javascript:void(0);"><img src="{{ asset('images/movie-thumb/05.jpg') }}"
                                                        class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-03"></a>
                                            </div>
                                            <div class="text-start ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-movie">
                                                <a href="javascript:void(0);"><img src="{{ asset('images/movie-thumb/10.jpg') }}"
                                                        class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-04"></a>
                                            </div>
                                            <div class="text-start ms-3">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="iq-movie">
                                                <a href="javascript:void(0);"><img src="{{ asset('images/movie-thumb/04.jpg') }}"
                                                        class="img-border-radius avatar-40 img-fluid" alt="recentlyImg-05"></a>
                                            </div>
                                            <div class="text-start ms-3">
