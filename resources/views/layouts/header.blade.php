...
{{--                                                href="movie/movie-list.html">Movie List</a></li>--}}
{{--                        <li class="nav-item">--}}
...
{{--                                id="tv-shows">--}}
{{--                                <li class="nav-item"><a class="nav-link "--}}
{{--                                                        href="tv-shows/show-list.html">Show List</a></li>--}}
{{--                                <li class="nav-item"><a class="nav-link "--}}
{{--                                                        href="tv-shows/season.html">Season</a></li>--}}
{{--                                <li class="nav-item"><a class="nav-link "--}}
{{--                                                        href="tv-shows/episodes.html">Episodes</a></li>--}}
{{--                            </ul>--}}
{{--                        </li>--}}
{{--                    </ul>--}}
{{--                </div>--}}
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button"
                       data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('images/user/01.jpg') }}" alt="User-Profile"
