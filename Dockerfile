...
RUN chown -R www-data:www-data /var/www/cms/storage /var/www/cms/bootstrap/cache
RUN chmod -R 775 /var/www/cms/storage /var/www/cms/bootstrap/cache
RUN echo "upload_max_filesize=2048M\npost_max_size=2048M" > /usr/local/etc/php/conf.d/uploads.ini
